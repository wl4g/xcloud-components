...
import static com.wl4g.components.support.redis.jedis.EnhancedJedisClusterCommand.EnhancedJedisClusterConntionHandler;
 ...
 * @see
 */
public class EnhancedJedisCluster extends JedisCluster implements JedisOperator {
	...
	public Object eval(final String script, final List<String> keys, final List<String> args) {
		RedisProtoUtil.checkArguments(keys);
		return new EnhancedJedisClusterCommand<Object>(connectionHandler, maxAttempts) {
			@Override
			public Object doExecute(Jedis connection) {
	 ...
	 */
	protected void checkArguments(final byte[]... keys) throws ParameterCanonicalException {
		if (safeMode) {

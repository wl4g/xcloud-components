...
public final class YamlEngine {
	 ...
	 *             IO Exception
	 */
	public static <T extends YamlConfiguration> T unmarshal(File yamlFile, final Class<T> classType,
			final Constructor classConstructor) throws IOException {
		yamlFile = new File(URLDecoder.decode(yamlFile.getCanonicalPath(), "UTF-8"));
	 ...
	 *             IO Exception
	 */
	public static <T extends YamlConfiguration> T unmarshal(final byte[] yamlBytes, final Class<T> classType,
			final Constructor classConstructor) throws IOException {

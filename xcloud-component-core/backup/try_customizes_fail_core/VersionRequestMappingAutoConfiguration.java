 ...
 */
public class VersionRequestMappingAutoConfiguration {
	...
	public static class ServletVersionRequestMappingConfiguration {
		 ...
		 * @see {@link org.springframework.web.servlet.DispatcherServlet#getHandler()}
		 */
		public static class ServletVersionRequestHandlerMapping extends ServletHandlerMappingSupport {
	...
	@Order(Ordered.HIGHEST_PRECEDENCE)
	public static class ReactiveVersionRequestMappingConfiguration {

		@Bean
		public org.springframework.web.reactive.result.method.annotation.RequestMappingHandlerMapping reactiveVersionRequestMappingHandlerMapping() {
		 ...
		 * @see {@link org.springframework.web.servlet.DispatcherServlet#getHandler()}
		 */
		public static class ReactiveVersionRequestHandlerMapping
			...
			@Override
			protected org.springframework.web.reactive.result.condition.RequestCondition<ReactiveVersionCondition> getCustomTypeCondition(
					Class<?> handlerType) {
				return createCondition(handlerType);
			}

			@Override
			protected org.springframework.web.reactive.result.condition.RequestCondition<ReactiveVersionCondition> getCustomMethodCondition(
					Method method) {
				return createCondition(method);
			}

			private org.springframework.web.reactive.result.condition.RequestCondition<ReactiveVersionCondition> createCondition(

...
public class PageHolder<E> implements Serializable {
	...
	// Default fallback local store.
	private static transient final ThreadLocal<PageHolder<?>> defaultLocal = new ThreadLocal<>();

	// Page storage local key.

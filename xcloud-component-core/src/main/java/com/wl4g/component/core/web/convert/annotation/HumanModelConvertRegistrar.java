 ...
 * @see
 */
public class HumanModelConvertRegistrar
	...
	public void registerBeanDefinitions(AnnotationMetadata metadata, BeanDefinitionRegistry registry) {
		AnnotationAttributes annoAttrs = AnnotationAttributes
				.fromMap(metadata.getAnnotationAttributes(EnableHumanModelConvert.class.getName()));
		if (!isNull(annoAttrs)) {
			...
			if (isServletWebApplication(getClass().getClassLoader(), (ConfigurableBeanFactory) beanFactory, environment,
				...
				// register human convert interceptor advisor.
				BeanDefinitionBuilder builder = genericBeanDefinition(HumanModelConvertAdvisor.class);
				builder.addPropertyValue("scanBasePackages", resolveScanBasePackages(annoAttrs, registry));
				builder.addPropertyValue("advice", new HumanModelConvertInterceptor());

				registerBeanDefinition(builder, registry, beanNameGenerator);
			} else { // Webflux
				// TODO
			}
		}
	...
	/**
	 * AOP advisor of {@link HumanModelConvertInterceptor}
	 */

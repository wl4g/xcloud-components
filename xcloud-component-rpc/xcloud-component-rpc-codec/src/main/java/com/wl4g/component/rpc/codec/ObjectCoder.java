...
public class ObjectCoder {
	 ...
	 * @param codecConfig
	 *            Codec configuration
	 *            {@linkplain com.wl4g.component.rpc.codec.CodecConfig
	 *            CodecConfig}.
	 */
	 ...
	 * {@linkplain com.wl4g.component.rpc.codec.type.OCObject OCObject} to
	 * encode data really.
	 * 
	 * @param msg
	 *            Message java object.
	...
	/**
	 * Encode message {@linkplain com.wl4g.component.rpc.codec.type.OCObject
	 * OCObject}.
	 * 
	 * @param msg
	 *            Message {@linkplain com.wl4g.component.rpc.codec.type.OCObject
	 *            OCObject}.
	 * @return If successful encoding, return bytes array. Otherwise return
	 *         null. If runtime exception occurred when encoding, it will throw
	 *         EncodingException, ReflectException and other wrapper's
	 ...
	 *         {@linkplain com.wl4g.component.rpc.codec.type.OCObject OCObject}.
	...
	/**
	 * Decode message {@linkplain com.wl4g.component.rpc.codec.type.OCObject
	 * OCObject}.
	 * 
	 * @param bytes
	 *            Message bytes array.
	 * @param source
	 *            Decode target
	 *            {@linkplain com.wl4g.component.rpc.codec.type.OCObject
	 *            OCObject}.
	 * @return If successful decoding, return
	 *         {@linkplain com.wl4g.component.rpc.codec.type.OCObject OCObject}.
	 *         Otherwise return null. If runtime exception occurred when

...
Codec Type
-------------
Besides using JAVA type directly, developers can use codec type which is in package com.wl4g.component.rpc.codec.type more flexibly to code.<br/>
...
--------------------
To replace the large bytes and coding slowly of JAVA serialization, we can use xcloud-component-rpc-codec's simple serialization instead.
...
Fields Cache
-----------------
To encode or decode object, xcloud-component-rpc-codec will get object's valid fields. We can use field cache to improve the speed
...
I wish you a pleasant to use xcloud-component-rpc-codec. If you have some good advice or bug report, please share with us. Thank you!
 ...
 */
package com.wl4g.components.rpc.core.springcloudfeign.util;
...
import com.wl4g.components.rpc.core.springcloudfeign.FeignProxyController;
 ...
 * @see
 */
public abstract class FeignProxiesUtils {

...
/**
 * {@link IstioFeignAutoConfiguration}
 * 
 ...
 * @see
 */
public class IstioFeignAutoConfiguration {

	@Bean
	public IstioFeignProperties istioFeignProperties() {
		return new IstioFeignProperties();
	}

	@Bean
	public ConnectionPool okHttp3ConnectionPool(IstioFeignProperties config) {
	...
	public Client okHttpFeignClient(IstioFeignProperties config, ConnectionPool connectionPool) {
